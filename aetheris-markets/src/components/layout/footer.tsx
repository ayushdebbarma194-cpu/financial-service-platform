...
import { SITE_CONFIG, SOCIAL_LINKS, FOOTER_LINKS } from "@/constants/site";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-sm text-muted-foreground max-w-md leading-relaxed">
              Professional market research and structured trading guidance.
              We prioritize disciplined analysis, transparent communication,
              and risk management above all else.
            </p>
            {/* Social Links */}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-muted-foreground text-center sm:text-right max-w-md">
            ...
            Please read our Risk Disclosure before subscribing.
          </p>
        </div>
      </div>
    </footer>
